...
class ToastMessage extends Component {
  ...
  render() {
    const { toastMsg, toastMsgAuth } = this.props;
    return (
      <div
        className="toast"
        role="alert"
      ...
      >
        <div className="toast-header">
          ...
          <strong className="ml-2 mr-auto">{toastMsg.title || toastMsgAuth.title}</strong>
          <button
            type="button"
        ...
        <div className="toast-body">{toastMsg.text || toastMsgAuth.text}</div>
      </div>
    );
  }
}
